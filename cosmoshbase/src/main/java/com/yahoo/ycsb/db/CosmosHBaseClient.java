...
import com.dianping.cosmos.hbase.client.CosmosHClient;
 ...
 */
public class CosmosHBaseClient extends com.yahoo.ycsb.DB
{
...
//    private static final Configuration config = HBaseConfiguration.create(); //new HBaseConfiguration();
  private static final CosmosHClient client = CosmosHClient.getInstance();
    ...
    public void getHTable(String table) throws IOException
    {
        synchronized (tableLock) {
            _hTable = client.getHTable(table);
            ...
            Thread t=new Thread()
            {
                public void run()
                {
                    try
                    {
                        ...
                        CosmosHBaseClient cli=new CosmosHBaseClient();
